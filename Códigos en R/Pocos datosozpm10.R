...
sigma[1] ~ dgamma(9,7)
alpha[2] ~ dgamma(10404,10200)
sigma[2] ~ dgamma(129,33.2)
theta ~ dunif(-1,1)
} 
"
#alpha[1] ~ dgamma(1,4)
...
bivariado_oz_pm10params= c("theta","sigma","alpha","m","lambda")
...
mod_oz_pm10_sim =coda.samples(model=modbiv_oz_pm10, bivariado_oz_pm10params, n.iter=5000, thin=10)


summary(mod_oz_pm10_sim[c(1,2)][,c(1:2,30339:30341)])$statistics[1:5,1]#500
summary(mod_oz_pm10_sim[c(1,2)][,c(1:2,15975:15977)])$statistics[1:5,1]#400
summary(mod_oz_pm10_sim[c(1,2)][,c(1:2,20003:20005)])$statistics[1:5,1]
